...
> British English edition of the [canonical page](../../../reference/session-profiles.md) for OmsiLaunch 0.1.0-beta3. The US English page is normative: where the two differ, it and the code take precedence.
